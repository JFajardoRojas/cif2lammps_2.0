...
## The original cutoff was set to be 5. It was modified to fit Hexane and DMF cases.

def initialize_system(filename, charges=False, small_molecule_cutoff=12, read_pymatgen=False):
...
def duplicate_system(system, replications, small_molecule_cutoff=12):
