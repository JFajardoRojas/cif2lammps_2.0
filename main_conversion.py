...
def run_conversion():
    ...
    parser.add_argument('--small_molecule_force_field', action='store', dest='sm_ff_string', type=str, required=False, default='UFF', help='the force field to use for small molecules')
